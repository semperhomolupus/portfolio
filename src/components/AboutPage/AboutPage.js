                    ...
                    <div className={styles.AboutPage}>
                        <div className={styles.AboutPage_info}>
                            ...
                            <div className={styles.AboutPage_descr}>
                                ...
                                <p>
                                     <span className={styles.colored}>В 2015 году</span> с головой погрузился в изучение верстки, а в 2016 ушел с работы и целый год
                                    держался на фрилансе. Устав от чувства нестабильности, я устроился <span className={styles.colored}>HTML-верстальщиком</span> в офис в Волгограде.
                                    Еще на испытательном сроке понял, что подобная простая и монотонная работа не для меня.
